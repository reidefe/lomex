...
class userProfileTestCase(APITestCase):
    ...
    def setUp(self):
        ...
        self.user = self.client.post(
            "/auth/users/", data={"username": "foxy", "password": "aidenogie"}
        )
        # obtain a json web token for the newly created user
        response = self.client.post(
            "/auth/jwt/create/", data={"username": "foxy", "password": "aidenogie"}
        )
    ...
    def test_userprofile_profile(self):
        profile_data = {
            "description": "I dont know why i was made to write this complex test"
        }
